...
@androidx.room.Database(entities = {ResultComics.class, ResultEvents.class, ResultCharacters.class}, version = 1, exportSchema = false)
@TypeConverters({ComicConverters.class, EventoConverters.class, PersonagensConverters.class})
